...
public final class PermissionConstants {
    ...
    public static final String READ_PHONE = permission.READ_PHONE_STATE;
    ...
    public static final String[] READ_PHONE_GROUP = {
            permission.READ_PHONE_STATE
    };
    public static final String[] GROUP_READ_EXTERNAL_STORAGE = {
            permission.READ_EXTERNAL_STORAGE
    };
    public static final String[] GROUP_WRITE_EXTERNAL_STORAGE = {
    ...
    public static String[] getPermissions(@Permission final String permission) {
        switch (permission) {
            ...
            case READ_EXTERNAL_STORAGE:
                return GROUP_READ_EXTERNAL_STORAGE;

            case WRITE_EXTERNAL_STORAGE:

                return GROUP_WRITE_EXTERNAL_STORAGE;
        }
